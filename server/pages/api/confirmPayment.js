...
module.exports = __webpack_require__("bIzq");
...
const confimPayment = async (req, res) => {
  ...
  const sign = Object(crypto__WEBPACK_IMPORTED_MODULE_0__["createHash"])('sha1').update(`${process.env.LIQPAY_PRIVATE_KEY}${data}${process.env.LIQPAY_PRIVATE_KEY}`).digest('base64');
...
/* harmony default export */ __webpack_exports__["default"] = (confimPayment);
