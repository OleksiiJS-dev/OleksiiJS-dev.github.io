...
module.exports = __webpack_require__("SwbS");
...
/* harmony default export */ __webpack_exports__["default"] = (async (req, res) => {
  const filters = Object.keys(req.query).filter(param => !param.startsWith('__next'));
  const requestFilters = filters.reduce((requestFilters, param) => requestFilters + `${param}=${req.query[param]}`, '');
  const cockpitGoods = await Object(_src_utils_getCockpitData__WEBPACK_IMPORTED_MODULE_0__[/* getCockpitCollection */ "a"])('Goods', requestFilters);
